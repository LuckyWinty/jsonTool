(function(){
 ...
 window.onload=function(){
	...
	{"name": "焦点数据" ,"nick":"mpmData","type":"level","dataFormat":[
		{"name":"广告组ID" ,"nick":"gid","type":"id" },
		{"name":"广告位ID" ,"nick":"locationId","type":"id" },
		{"name":"素材拉取数量" ,"nick":"pc","type":"number" },
		{"name":"默认展示数量","nick":"shownum","type":"number"}
	]},
	{"name":"开始时间" ,"nick":"begin","type":"date" },
	{"name":"结束时间" ,"nick":"end","type":"date" },
	{"name":"ptag-domain","nick":"ptagdomain","type":"ptagDomain","ps":"1111.1"}
];
